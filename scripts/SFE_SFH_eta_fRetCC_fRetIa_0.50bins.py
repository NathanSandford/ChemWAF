...
output_file = Path('/global/scratch/users/nathan_sandford/ChemEv/EriII/samples/SFE_SFH_eta_fRetCC_fRetIa_0.50bins.npz')
...
gal_priors = dict(
    ...
    fRetCC=GaussianLogPrior('fRetCC', 1, 0.3, 0, 1),
    fRetIa=GaussianLogPrior('fRetIa', 1, 0.3, 0, 1),
)
