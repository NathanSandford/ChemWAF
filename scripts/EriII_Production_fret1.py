...
results_file = Path('/global/scratch/users/nathan_sandford/ChemEv/EriII/samples/EriII_fret1.npz')
p0_file = Path('/global/scratch/users/nathan_sandford/ChemEv/EriII/data/EriII_fret1_p0.npy')
