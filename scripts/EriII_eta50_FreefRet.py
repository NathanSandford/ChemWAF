...
results_file = Path('/clusterfs/dweisz/nathan_sandford/github_repos/ChemWAF/samples//EriII_eta50_FreefRet.npz')
p0_file = Path('/clusterfs/dweisz/nathan_sandford/github_repos/ChemWAF/samples/EriII_eta50_FreefRet_p0.npy')
...
gal_priors = dict(
    ...
    eta=GaussianLogPrior('eta', 50, 10, 0, 1e3),
    fRet=UniformLogPrior('fRet', 0, 1, -np.inf),
)
