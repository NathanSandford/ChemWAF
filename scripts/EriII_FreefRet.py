...
results_file = Path('/global/scratch/users/nathan_sandford/ChemEv/EriII/samples/EriII_FreefRet.npz')
p0_file = Path('/global/scratch/users/nathan_sandford/ChemEv/EriII/data/EriII_FreefRet_p0.npy')
