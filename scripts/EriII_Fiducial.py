...
results_file = Path('/global/scratch/users/nathan_sandford/ChemEv/EriII/samples/EriII_Fiducial.npz')
p0_file = Path('/global/scratch/users/nathan_sandford/ChemEv/EriII/data/EriII_Fiducial_p0.npy')
