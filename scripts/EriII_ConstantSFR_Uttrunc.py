...
results_file = Path('/clusterfs/dweisz/nathan_sandford/github_repos/ChemWAF/samples/EriII_ConstantSFR_Uttrunc.npz')
p0_file = Path('/clusterfs/dweisz/nathan_sandford/github_repos/ChemWAF/samples/EriII_ConstantSFR_Uttrunc_p0.npy')
...
gal_priors = dict(
    ...
    t_trunc=UniformLogPrior('t_trunc', 10*dt, 2.5 -np.inf),
