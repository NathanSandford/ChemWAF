...
results_file = Path('/global/scratch/users/nathan_sandford/ChemEv/EriII/samples/EriII_eta20_FreefRet2.npz')
p0_file = Path('/global/scratch/users/nathan_sandford/ChemEv/EriII/data/EriII_eta20_FreefRet2_p0.npy')
