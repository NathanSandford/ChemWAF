...
results_file = Path('/global/scratch/users/nathan_sandford/ChemEv/EriII/samples/EriII_noIa.npz')
p0_file = Path('/global/scratch/users/nathan_sandford/ChemEv/EriII/data/EriII_noIa_p0.npy')
