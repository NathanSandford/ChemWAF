...
results_file = Path('/global/scratch/users/nathan_sandford/ChemEv/EriII/samples/EriII_ConstantSFR.npz')
p0_file = Path('/global/scratch/users/nathan_sandford/ChemEv/EriII/data/EriII_ConstantSFR_p0.npy')
