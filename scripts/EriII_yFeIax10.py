...
results_file = Path('/global/scratch/users/nathan_sandford/ChemEv/EriII/samples/EriII_yFeIax10.npz')
p0_file = Path('/global/scratch/users/nathan_sandford/ChemEv/EriII/data/EriII_yFeIax10_p0.npy')
