...
results_file = Path('/clusterfs/dweisz/nathan_sandford/github_repos/ChemWAF/samples/EriII_LinExp.npz')
p0_file = Path('/clusterfs/dweisz/nathan_sandford/github_repos/ChemWAF/samples/EriII_LinExp_p0.npy')
...
gal_priors = dict(
    ...
    tauSFH=GaussianLogPrior('tauSFH', 0.2, 0.1, 0.01, np.inf),
