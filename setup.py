...
# Package meta-data.
NAME = "ChemWAF"
DESCRIPTION = "Packaging of chemical evolution model from Weinberg, Andrews, & Freudenburg 2017, ApJ 837, 183"
URL = "https://github.com/NathanSandford/waf"
